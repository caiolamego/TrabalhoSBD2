...
def execute_bronze_silver_notebook():
    ...
    output_notebook = f'/opt/airflow/silver/outputs/bronze_silver_executed_{datetime.now().strftime("%Y%m%d_%H%M%S")}.ipynb'
...
with DAG(
    ...
    schedule_interval='0 4 * * *',  # Executa diariamente às 4:00 AM (após as coletas)
